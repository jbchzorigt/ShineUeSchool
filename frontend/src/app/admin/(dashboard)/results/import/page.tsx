    ...
    <div className="max-w-4xl space-y-6">
      ...
      <Card className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/admin/results" className="ml-auto self-center text-sm font-semibold text-navy hover:underline">Үр дүн рүү →</Link>
        </div>
      ...
      {report && (
        <Card className="space-y-4">
          ...
          {done && <Link href="/admin/results"><Button variant="secondary">Үр дүнг харах →</Button></Link>}
        </Card>
      )}
    </div>
  );
